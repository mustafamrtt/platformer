    ...
    platforms = [
        ...
        new Platform(2950, 225, 850, 800),
        new Platform(3800, 650, 1000, 100), //diken koyulacak.
        new Platform(4050, 225, 100, 20),
        new Platform(4400, 225, 100, 20),
        new Platform(4800, 225, 850, 800),
